            ...
            while (seguir == true) { //valida que el usuario quiera seguir digitando opciones
                ...
                switch (opcion) {
                    case 1:
                        ...
                        } catch (Exception InputMismatchException) {  //valida que el tipo de reporte digitado sea un numero
                    ...
                    case 2:
                        ...
                        System.out.println(control.getAllReports()); //muestra todos los reportes guardados en el sistema
